...
2. Read [.claude/rules/money-calculations.md](../../rules/money-calculations.md) for the derivation.
...
4. Make the change in `js/store.js` **and** update `.claude/rules/money-calculations.md` in the same commit.
