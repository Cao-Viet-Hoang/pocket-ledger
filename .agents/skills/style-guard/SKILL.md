...
Before you write or edit code in Pocket Ledger, tick through this checklist. It encodes the decisions in [.Codex/rules/coding-style.md](../../rules/coding-style.md), [.Codex/rules/ui-patterns.md](../../rules/ui-patterns.md), and [.Codex/rules/i18n.md](../../rules/i18n.md).
...
- [ ] Placed under an existing namespace (see [.Codex/rules/i18n.md](../../rules/i18n.md)) — no new top-levels without asking.
